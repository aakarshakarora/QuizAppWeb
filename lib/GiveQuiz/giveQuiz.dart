              ...
              onPressed: () async {
                setState(() {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            QuizCodeDesc(_accessCodeController.text.trim())),
                  );
                });
              },
              child: Text("Submit"),
              ...
              builder: (BuildContext context,
                ...
                if (snapshot.hasData == false) {
                  return Center(
                    ...
                    valueColor:
                        new AlwaysStoppedAnimation<Color>(Color(0xff631aaf)),
                    strokeWidth: 5,
                  ));
                } else {
                  if (snapshot.requireData.exists == false) {
                    ...
                    return Column(
                      children: [
                        ...
                        groupCheck == true
                            ? Text("You are allowed to give Quiz")
                            : Text("You are not allowed to give Quiz"),
                        TextButton(
                            onPressed: () async {
